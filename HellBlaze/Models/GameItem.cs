...
public class Weapon : GameItem
{
    ...
    public decimal TotalWeight => Fire + Precision + Electrical + Laser + Explosive + AntiTank + Gas + Smoke + AntiHorde;
}
...
public class Stratagem : GameItem
{
    ...
    public decimal TotalWeight => Fire + Precision + Electrical + Laser + Explosive + AntiTank + Gas + Smoke + AntiHorde + Mine + Turret;
}
